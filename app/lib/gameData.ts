...
const categorySeed: Array<Omit<GameCategory, 'levels'>> = [
  {
    ...
    longDescription: 'Amaze Game beginner levels are designed for fast starts, clear goals, and casual sessions.',
  },
  {
    slug: 'classic',
    name: 'Classic',
    ...
    longDescription: 'Amaze Game classic levels give players a balanced route through the core game experience.',
  },
  {
    slug: 'challenge',
    name: 'Challenge',
    ...
    longDescription: 'Amaze Game challenge levels are built for players who enjoy tougher decisions and longer sessions.',
  },
  {
    slug: 'expert',
    name: 'Expert',
    ...
    longDescription: 'Amaze Game expert levels collect the most demanding scenarios for experienced players.',
  },
];
