...
const SITE_URL = 'https://amaze-game.com';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Amaze Game',
        url: SITE_URL,
        description: 'Play Amaze Game free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Amaze Game online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
