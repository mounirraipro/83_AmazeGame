...
export const metadata: Metadata = {
    ...
    description: 'Amaze Game is a safe, educational, and family-friendly game. Learn how we protect children and promote healthy screen time.',
    keywords: ['Amaze Game for kids', 'safe game', 'children online safety', 'educational game', 'family friendly games'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Everything parents need to know about Amaze Game and online safety.</p>
                </div>
            </div>
            ...
            <div className="page-content">
                ...
                <p>
                    Amaze Game is a family-friendly game created to provide wholesome entertainment
                    for players of all ages. We understand that parents care deeply about what their children
                    do online, and we&apos;ve built Amaze Game with safety, education, and fun as our core priorities.
                </p>
                ...
                <p>
                    ...
                    children and adults alike. Here&apos;s what your child gains from playing Amaze Game:
                </p>
                <ul>
                ...
                <p>
                    Amaze Game does not collect any personal information from children. There are no
                ...
                <p>
                    Amaze Game is completely free to play with no hidden costs. There are no virtual
                ...
                <p>
                    All content used in Amaze Game is carefully curated to be appropriate for all ages.
                    All content in Amaze Game is carefully selected to be appropriate for all ages.
                </p>

                <h3>Advertisements</h3>
                <p>
                    Amaze Game displays advertisements to support the free service. These ads are served
                ...
                <p>
                    We take the Children&apos;s Online Privacy Protection Act (COPPA) seriously. Amaze Game
                ...
                <p>
                    While Amaze Game is designed to be safe, we encourage parents to take an active role
                ...
                <ol>
                    ...
                    <li><strong>Discuss online safety:</strong> Use Amaze Game as a starting point to talk about safe internet habits.</li>
                ...
                <h2>Have Concerns?</h2>
                <p>
                    If you have any questions or concerns about your child&apos;s experience on Amaze Game,
