...
export const metadata: Metadata = {
    ...
    description: 'Read the Amaze Game Terms of Service. Understand the rules and guidelines for using our free online game.',
    keywords: ['Amaze Game terms of service', 'terms and conditions', 'usage agreement'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    Welcome to Amaze Game. By accessing or using our website and game, you agree to be
                    bound by these Terms of Service. Please read them carefully before using our services.
                </p>

                <h2>1. Acceptance of Terms</h2>
                <p>
                    By accessing Amaze Game at amaze-game.com, you acknowledge that you have read,
                ...
                <p>
                    Amaze Game provides a free, browser-based game. Amaze Game is a free, browser-based game experience.
                    The service includes the game itself, educational content, blog articles, and related resources.
                </p>

                <h2>3. User Eligibility</h2>
                <p>
                    Amaze Game is available to users of all ages. However, users under 13 years of age
                ...
                <p>
                    All content on Amaze Game — including but not limited to the game design, code, images,
                    text, graphics, logos, and audio — is the intellectual property of Amaze Game or its
                ...
                <p>
                    ...
                    Amaze Game for personal, non-commercial purposes only.
                </p>

                <h2>5. Acceptable Use</h2>
                <p>When using Amaze Game, you agree NOT to:</p>
                <ul>
                ...
                <p>
                    ...
                    grant Amaze Game a non-exclusive, royalty-free, perpetual license to use, modify,
                    and incorporate that content into our services.
                </p>

                <h2>7. Advertisements</h2>
                <p>
                    Amaze Game displays advertisements from third-party ad networks, including Google
                ...
                <p>
                    Amaze Game is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any
                ...
                <p>
                    To the fullest extent permitted by law, Amaze Game and its operators shall not be
                ...
                <p>
                    We reserve the right to suspend or terminate your access to Amaze Game at our sole
                ...
                <p>
                    ...
                    <strong>legal@amaze-game.com</strong>.
                </p>
            </div>
        </>
    );
