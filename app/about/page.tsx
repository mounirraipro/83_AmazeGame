...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Amaze Game',
        url: 'https://amaze-game.com/about',
        description: 'Learn about Amaze Game, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Amaze Game',
...
export const metadata: Metadata = {
    title: 'About Us – Amaze Game',
    description: 'Learn about Amaze Game, our mission, and the team behind the game.',
    keywords: ['about Amaze Game', 'game team', 'who made Amaze Game'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Amaze Game</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Amaze Game was born from a simple idea: what if playing Amaze Game could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Amaze Game with a clear vision — to create a free, accessible, and
                    ...
                    Amaze Game has something for you.
                </p>
                ...
                <p>
                    Every level in Amaze Game is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Amaze Game offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Amaze Game better for
                    everyone.
                </p>
            </div>
        </>
