...
export const metadata: Metadata = {
    ...
    description: 'Read the Amaze Game Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Amaze Game privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Amaze Game, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Amaze Game, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Amaze Game is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@amaze-game.com</strong>.
                </p>
            </div>
        </>
    );
