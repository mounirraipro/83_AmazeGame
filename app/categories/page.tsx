...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Amaze Game puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Amaze Game categories'],
  alternates: {
