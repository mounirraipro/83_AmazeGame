...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Amaze Game disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Amaze Game disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Amaze Game (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on amaze-game.com
                ...
                <p>
                    Amaze Game is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Amaze Game displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Amaze Game.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Amaze Game is not responsible for any errors
