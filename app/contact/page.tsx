...
const SUPPORT_EMAIL = 'hello@amaze-game.com';

export const metadata: Metadata = {
    title: 'Contact Amaze Game',
    description: 'Get in touch with the Amaze Game team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Amaze Game', 'Amaze Game support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
