...
export const metadata: Metadata = {
    ...
    description: 'Amaze Game is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Amaze Game accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Amaze Game accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Amaze Game is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Amaze Game presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Amaze Game. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@amaze-game.com</strong></li>
                </ul>
                <p>
