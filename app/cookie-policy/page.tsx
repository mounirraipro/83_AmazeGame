...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Amaze Game uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Amaze Game cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Amaze Game uses them, and how you can
                ...
                <p>Amaze Game uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Amaze Game.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@amaze-game.com</strong>.
                </p>
            </div>
        </>
    );
